...
\begin{center}
  \begin{tikzpicture}
    \begin{axis}[xmin=0,ymin=-2,xmax=5,ymax=2]
      \coordinate (O) at (0,0);
      \node[fill=white,circle,inner sep=0pt] (O-label) at ($(O)+(-135:10pt)$) {$O$};
      \addplot[red,thick,restrict y to domain=-2:2,smooth,samples=500] {ln(x)};
    \end{axis}
  \end{tikzpicture}
\end{center}
...
\begin{center}
  \begin{tikzpicture}
    \begin{axis}[xmin=0,ymin=-2,xmax=5,ymax=2]
      \coordinate (O) at (0,0);
      \node[fill=white,circle,inner sep=0pt] (O-label) at ($(O)+(-135:10pt)$) {$O$};
      \addplot[red,thick,restrict y to domain=-2:2,smooth,samples=500] {ln(x)/ln(0.5)};
    \end{axis}
...
\begin{center}
  \begin{tikzpicture}
    \begin{axis}[xmin=-3,ymin=0,xmax=2,ymax=4]
      \coordinate (O) at (0,0);
      \node[fill=white,circle,inner sep=0pt] (O-label) at ($(O)+(-135:10pt)$) {$O$};
      \addplot[red,thick,smooth,samples=500] {exp(x)};
    \end{axis}
  \end{tikzpicture}
\end{center}
...
\begin{center}
  \begin{tikzpicture}
    \begin{axis}[xmin=-2,ymin=0,xmax=3,ymax=4]
      \coordinate (O) at (0,0);
      \node[fill=white,circle,inner sep=0pt] (O-label) at ($(O)+(-135:10pt)$) {$O$};
      \addplot[red,thick,smooth,samples=500] {0.5^x};
    \end{axis}
