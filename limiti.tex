...
\begin{definizioneLimiteFinitoDestro}
	...
	\lim\limits_{x\to x_0^+} f(x) &= l\\
	\ArrowBetweenLines
	\forall \varepsilon>0, \exists\,\delta_\varepsilon>0\mid\forall x: x_0< x &<x_0+\delta_\varepsilon 
...
\begin{definizioneLimiteFinitoSinistro}
	...
	\lim\limits_{x\to x_0^-} f(x) &= l\\
	\ArrowBetweenLines
	\forall \varepsilon>0, \exists\,\delta_\varepsilon>0\mid\forall x: x_0-\delta_\varepsilon<x&<x_0
	\Rightarrow \vert f(x) - l\vert < \varepsilon
	\end{align*}
