...
\subsubsection{Punto su un segmento in un rapporto $\dfrac{m}{n}$}
...
Come in ogni esercizio di geometria, partiamo dal disegno. Lo miglioreremo man mano che andiamo avanti.
\begin{center}
...
\subsection{\hyperref[subsec:geomanal:parabola]{Parabola}}\label{ex:parabola}
\paragraph{Esercizio 1}
...
\subsection{\hyperref[subsec:geomanal:ellisse]{Ellisse}}\label{ex:ellisse}
\paragraph{Esercizio 1}
