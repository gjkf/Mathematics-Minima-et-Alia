...
\begin{equation*}
n! = n\cdot (n-1) \cdot (n-2) \cdots 2\cdot1 = \prod\limits_{1}^{n}n
\end{equation*}
...
\begin{equation*}
\mathscr{D}_{n,k} = \frac{n!}{(n-k)!} = n(n-1)\cdots(n-k+1)
\end{equation*}
...
\subsubsection{Semplici}
\begin{equation*}
\mathscr{P}_n = \mathscr{D}_{n,n} = n!
\end{equation*}

\subsubsection{Con ripetizione}
\begin{equation*}
\mathscr{P}_n^{\alpha_1,\alpha_2,\dots,\alpha_n} = \frac{n!}{\alpha_1!\alpha_2!\cdots\alpha_n!}
\end{equation*}
...
\subsubsection{Semplici}
\begin{equation*}
\mathscr{C}_{n,k} = \frac{\mathscr{D}_{n,k}}{k!} = \binom{n}{k} = \frac{n!}{k!(n-k)!}
\end{equation*}

\subsubsection{Con ripetizione}
\begin{equation*}
\mathscr{C}'_{n,k} = \binom{n+k+1}{k}
\end{equation*}
