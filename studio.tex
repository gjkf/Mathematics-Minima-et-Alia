...
\subsection{Teorema del criterio della derivabilità}
\begin{deriv}\hypertarget{teor:deriv}
  Sia $f$ continua in $x_0$ e derivabile in $U\setminus\{x_0\}$. Se esiste finito
  \begin{equation*}
    \lim\limits_{x\to x_0} f'(x)
  \end{equation*}
\end{deriv}
allora $f$ è derivabile in $x_0$ e si ha che
\begin{equation*}
